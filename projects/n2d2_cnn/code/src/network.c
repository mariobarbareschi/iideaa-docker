...
/************************************LAYER (2)***/
   ...
   gettimeofday(&start, NULL);
#endif
    poolcell_propagate_unitmap(POOL1_NB_CHANNELS, POOL1_CHANNELS_HEIGHT, POOL1_CHANNELS_WIDTH, POOL1_STRIDE_Y, POOL1_STRIDE_X, conv1_data, POOL1_NB_OUTPUTS, POOL1_OUTPUTS_HEIGHT, POOL1_OUTPUTS_WIDTH, POOL1_NB_OUTPUTS, POOL1_OUTPUT_OFFSET, pool1_data, POOL1_POOL_HEIGHT, POOL1_POOL_WIDTH, POOL1_POOLING, POOL1_ACTIVATION, POOL1_SHIFT);
#ifdef TIME_ANALYSIS
    gettimeofday(&end, NULL);
...
/************************************LAYER (6)***/
   ...
   gettimeofday(&start, NULL);
#endif
    fccell_propagate_2d(CONV3_NB_OUTPUTS, CONV3_OUTPUTS_HEIGHT, CONV3_OUTPUTS_WIDTH, conv3_data, FC1_NB_OUTPUTS, FC1_NB_OUTPUTS, FC1_OUTPUT_OFFSET, fc1_data, FC1_NB_CHANNELS, fc1_biases, fc1_weights, FC1_ACTIVATION, FC1_SHIFT);
#ifdef TIME_ANALYSIS
    gettimeofday(&end, NULL);
...
/************************************LAYER (7)***/
   ...
   gettimeofday(&start, NULL);
#endif
    fccell_propagate(FC2_NB_CHANNELS, fc1_data, OUTPUTS_SIZE*NB_OUTPUTS, FC2_NB_OUTPUTS, FC2_OUTPUT_OFFSET, output_data, fc2_biases, fc2_weights, FC2_ACTIVATION, FC2_SHIFT);
#ifdef TIME_ANALYSIS
    gettimeofday(&end, NULL);
