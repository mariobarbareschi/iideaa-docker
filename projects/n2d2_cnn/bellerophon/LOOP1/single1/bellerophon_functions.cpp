...
extern "C" double BELLERO_Reward()
{
  ...
  double conv1_skipped_loops = 25 * (stride1_norm - 1) / stride1_norm;
  double conv2_skipped_loops = 25 * (stride2_norm - 1) / stride2_norm;
  double conv3_skipped_loops = 25 * (stride3_norm - 1) / stride3_norm;
