...
extern "C" double BELLERO_Reward()
{
	...
	double conv1_skipped_loops = conv1_inner_loops / (stride1 * stride2);
	double conv2_skipped_loops = conv2_inner_loops / (stride3 * stride4);
	double conv3_skipped_loops = conv3_inner_loops / (stride5 * stride6);
