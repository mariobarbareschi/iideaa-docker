...
int main(int argc, char* argv[])
{
	...
	if (argc < 2)
		//total = sortedFileList("/root/projects/n2d2_cnn/float/code/stimuli", &fileList, 0);
		total = sortedFileList("/home/ssaa/Git/iideaa-docker/projects/n2d2_cnn/float/code/stimuli", &fileList, 0);
	else
