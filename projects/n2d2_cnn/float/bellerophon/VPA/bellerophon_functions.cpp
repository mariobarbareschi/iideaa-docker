...
const char * stimuli_directory = "/root/projects/n2d2_cnn/float/code/stimuli";

extern "C" double BELLERO_getError() {    
	omp_set_num_threads(8);

	// Getting the success-rate of the original CNN
	FILE *oracle_file = fopen("/root/projects/n2d2_cnn/float/bellerophon/success_rate.txt", "r");
	if (oracle_file == NULL)
	{
