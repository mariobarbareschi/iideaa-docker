...
public:
    ...
    evoapprox_t& operator=(int8_t   value) {internal_type = int8;   actual_value = (uint64_t)value; return *this;}
    evoapprox_t& operator=(uint8_t  value) {internal_type = uint8;  actual_value = (uint64_t)value; return *this;}
    evoapprox_t& operator=(int16_t  value) {internal_type = int16;  actual_value = (uint64_t)value; return *this;}
    evoapprox_t& operator=(uint16_t value) {internal_type = uint16; actual_value = (uint64_t)value; return *this;}
