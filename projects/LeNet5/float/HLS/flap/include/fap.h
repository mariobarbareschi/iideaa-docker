...
namespace fap {
    ...
    public:
        ...
        FloatingPointType(float f, FloatPrecTy n_prec = {FLOAT_EXP_SIZE, FLOAT_MANT_SIZE}) {
                this->prec.mant_size = FLOAT_MANT_SIZE;
                this->prec.exp_size = FLOAT_EXP_SIZE;
                uint32_t f_as_4_byte = *(uint32_t *)(&f);
                this->setSign(f_as_4_byte >> (FLOAT_SIZE - FLOAT_SIGN_SIZE));
                this->setExp((f_as_4_byte >> (FLOAT_SIZE - FLOAT_SIGN_SIZE - FLOAT_EXP_SIZE)));
        ...
        FloatingPointType(double d, FloatPrecTy n_prec = {DOUBLE_EXP_SIZE, DOUBLE_MANT_SIZE}) {
                this->prec.mant_size = DOUBLE_MANT_SIZE;
                this->prec.exp_size = DOUBLE_EXP_SIZE;
                uint64_t d_as_8_byte = *(uint64_t *)(&d);
                this->setSign(d_as_8_byte >> (DOUBLE_SIZE - DOUBLE_SIGN_SIZE));
                this->setExp((d_as_8_byte >> (DOUBLE_SIZE - DOUBLE_SIGN_SIZE - DOUBLE_EXP_SIZE)));
        ...
        FloatingPointType(int i, FloatPrecTy n_prec = {DOUBLE_EXP_SIZE, DOUBLE_MANT_SIZE}) :
          FloatingPointType((double)i, n_prec) {}
