...
//  }
  ...
  for (unsigned int sy = syMin; sy < syMax; ++sy)
    for (unsigned int sx = sxMin; sx < sxMax; ++sx)
    {
      SUM_T prod = (SUM_T) (*weights[output][0])[sy][sx] * (SUM_T) ((UDATA_T) inputs[0][iy + sy][ix + sx]);
      weightedSum += prod;
    }
  ...
  for (unsigned int sy = syMin; sy < syMax; ++sy)
    for (unsigned int sx = sxMin; sx < sxMax; ++sx)
    {
      SUM_T prod = (SUM_T) (*weights[output][1])[sy][sx] * (SUM_T) ((UDATA_T) inputs[1][iy + sy][ix + sx]);
      weightedSum += prod;
    }
  ...
  for (unsigned int sy = syMin; sy < syMax; ++sy)
    for (unsigned int sx = sxMin; sx < sxMax; ++sx)
    {
      SUM_T prod = (SUM_T) (*weights[output][2])[sy][sx] * (SUM_T) ((UDATA_T) inputs[2][iy + sy][ix + sx]);
      weightedSum += prod;
    }
  ...
  for (unsigned int sy = syMin; sy < syMax; ++sy)
    for (unsigned int sx = sxMin; sx < sxMax; ++sx)
    {
      SUM_T prod = (SUM_T) (*weights[output][3])[sy][sx] * (SUM_T) ((UDATA_T) inputs[3][iy + sy][ix + sx]);
      weightedSum += prod;
    }
  ...
  for (unsigned int sy = syMin; sy < syMax; ++sy)
    for (unsigned int sx = sxMin; sx < sxMax; ++sx)
    {
      SUM_T prod = (SUM_T) (*weights[output][4])[sy][sx] * (SUM_T) ((UDATA_T) inputs[4][iy + sy][ix + sx]);
      weightedSum += prod;
    }
  ...
  for (unsigned int sy = syMin; sy < syMax; ++sy)
    for (unsigned int sx = sxMin; sx < sxMax; ++sx)
    {
      SUM_T prod = (SUM_T) (*weights[output][5])[sy][sx] * (SUM_T) ((UDATA_T) inputs[5][iy + sy][ix + sx]);
      weightedSum += prod;
    }
  return weightedSum;
}
...
//  }
  ...
  if (weights[output][6] != NULL)
    for (unsigned int sy = syMin; sy < syMax; ++sy)
      for (unsigned int sx = sxMin; sx < sxMax; ++sx)
      {
        SUM_T prod = (SUM_T) (*weights[output][6])[sy][sx] * (SUM_T) ((UDATA_T) inputs[6][iy + sy][ix + sx]);
        weightedSum += prod;
      }
  ...
  if (weights[output][7] != NULL)
    for (unsigned int sy = syMin; sy < syMax; ++sy)
      for (unsigned int sx = sxMin; sx < sxMax; ++sx)
      {
        SUM_T prod = (SUM_T) (*weights[output][7])[sy][sx] * (SUM_T) ((UDATA_T) inputs[7][iy + sy][ix + sx]);
        weightedSum += prod;
      }
  ...
  if (weights[output][8] != NULL)
    for (unsigned int sy = syMin; sy < syMax; ++sy)
      for (unsigned int sx = sxMin; sx < sxMax; ++sx)
      {
        SUM_T prod = (SUM_T) (*weights[output][8])[sy][sx] * (SUM_T) ((UDATA_T) inputs[8][iy + sy][ix + sx]);
        weightedSum += prod;
      }
  ...
  if (weights[output][9] != NULL)
    for (unsigned int sy = syMin; sy < syMax; ++sy)
      for (unsigned int sx = sxMin; sx < sxMax; ++sx)
      {
        SUM_T prod = (SUM_T) (*weights[output][9])[sy][sx] * (SUM_T) ((UDATA_T) inputs[9][iy + sy][ix + sx]);
        weightedSum += prod;
      }
  ...
  if (weights[output][10] != NULL)
    for (unsigned int sy = syMin; sy < syMax; ++sy)
      for (unsigned int sx = sxMin; sx < sxMax; ++sx)
      {
        SUM_T prod = (SUM_T) (*weights[output][10])[sy][sx] * (SUM_T) ((UDATA_T) inputs[10][iy + sy][ix + sx]);
        weightedSum += prod;
      }
  ...
  if (weights[output][11] != NULL)
    for (unsigned int sy = syMin; sy < syMax; ++sy)
      for (unsigned int sx = sxMin; sx < sxMax; ++sx)
      {
        SUM_T prod = (SUM_T) (*weights[output][11])[sy][sx] * (SUM_T) ((UDATA_T) inputs[11][iy + sy][ix + sx]);
        weightedSum += prod;
      }
  ...
  if (weights[output][12] != NULL)
    for (unsigned int sy = syMin; sy < syMax; ++sy)
      for (unsigned int sx = sxMin; sx < sxMax; ++sx)
      {
        SUM_T prod = (SUM_T) (*weights[output][12])[sy][sx] * (SUM_T) ((UDATA_T) inputs[12][iy + sy][ix + sx]);
        weightedSum += prod;
      }
  ...
  if (weights[output][13] != NULL)
    for (unsigned int sy = syMin; sy < syMax; ++sy)
      for (unsigned int sx = sxMin; sx < sxMax; ++sx)
      {
        SUM_T prod = (SUM_T) (*weights[output][13])[sy][sx] * (SUM_T) ((UDATA_T) inputs[13][iy + sy][ix + sx]);
        weightedSum += prod;
      }
  ...
  if (weights[output][14] != NULL)
    for (unsigned int sy = syMin; sy < syMax; ++sy)
      for (unsigned int sx = sxMin; sx < sxMax; ++sx)
      {
        SUM_T prod = (SUM_T) (*weights[output][14])[sy][sx] * (SUM_T) ((UDATA_T) inputs[14][iy + sy][ix + sx]);
        weightedSum += prod;
      }
  ...
  if (weights[output][15] != NULL)
    for (unsigned int sy = syMin; sy < syMax; ++sy)
      for (unsigned int sx = sxMin; sx < sxMax; ++sx)
      {
        SUM_T prod = (SUM_T) (*weights[output][15])[sy][sx] * (SUM_T) ((UDATA_T) inputs[15][iy + sy][ix + sx]);
        weightedSum += prod;
      }
  return weightedSum;
}
